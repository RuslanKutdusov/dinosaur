...
#define ERASABLE_LOOP(CONTAINER, ERASABLE_ITER, INC_ITER) for(auto ERASABLE_ITER = CONTAINER.begin(), INC_ITER = ERASABLE_ITER; ERASABLE_ITER != CONTAINER.end(); ERASABLE_ITER = INC_ITER)
